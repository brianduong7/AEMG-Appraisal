  ...
  return createPortal(
    <>
      ...
      <div
        ...
        className="fixed left-1/2 top-1/2 z-[200] flex max-h-[min(90vh,100dvh)] w-[min(calc(100vw-2rem),42rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white text-black shadow-xl"
      >
