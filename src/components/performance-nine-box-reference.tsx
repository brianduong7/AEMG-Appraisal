...
const axisCell =
  "bg-navy-100 px-2 py-2 text-center text-xs font-semibold text-black align-middle border border-zinc-300";
const cornerCell =
  "bg-navy-100 px-2 py-2 text-center text-[11px] font-semibold leading-tight text-black border border-zinc-300 min-w-[7rem]";
const dataCell =
