...
export function entityShellClass(entity: string | null | undefined): string {
  ...
  const map: Record<string, string> = {
    ...
    "HQ Corporate Services": `${base} from-slate-100 via-zinc-50 to-zinc-100 border-t-4 border-slate-500/50 dark:from-slate-900/50 dark:via-zinc-950 dark:to-zinc-950 dark:border-navy-500/35`,
